...
class BehaviorThreads(object):
    ...
    def __init__(self, robot_list):
        ...
        ###################################
        t_motion_handler = threading.Thread(name='handler thread', target=self.robot_motion_handler, args= (self.motion_q,))
        t_motion_handler.setDaemon(True)
