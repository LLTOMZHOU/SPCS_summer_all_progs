...
class virtual_robot:
    def __init__(self):
        ...
        self.a = 0 # angle of the robot, 0 when aligned with vertical axis
        self.dist_l = False
...
class virtual_world:
    ...
    def draw_map(self):
        ...
        for rect in self.map:
            #translate the coordinates in Cartesian coordinate system
    ...
    def draw_robot(self):
        ...
        #translate the coordinates in the Cartesian Plain to 
        #the coordinates in the Canvas
    ...
    def get_vrobot_prox(self, side):
        ...
        #given the current steering and position, see if anything is in
        #front of the robot
    ...
    def draw_floor(self, side):
        ...
        vrobot = self.vrobot
        if (side == "left"):
            border = vrobot.floor_l #the value of the virtual or real reading
            floor_id = vrobot.floor_l_id #the vrobot.floor_l is a handle
